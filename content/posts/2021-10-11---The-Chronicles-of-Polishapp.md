...
A Chrome extension for UX writers, Content Designers, Product Marketers, and Content Marketers. Usually, these professionals don't have access to design tools like Figma, especially if they are external consultants. If they are assigned to re-word existing pages, they can rarely get an up-to-date version of that page in Figma. Their process is highly collaborative and includes working with professionals from other disciplines like Design, Engineering, Legal, etc. Their changes go through multiple rounds of approval. They will often receive feedback about how the new copy sits within the site layout.
Polish makes this process easier by turning web pages to be editable. 
When editing pages using Polish, you know you're working on the source of truth. Changes are immediately reflected in the site's layout. It allows sharing your revisions with others and toggling between the original text and your text.
...
- This was a hard realization since we don't have the financials to do that.

### July 11-30 2021
- We've shipped many changes and fixes to make the core functionality even slicker and some other complementary features per users' feedback.
- Polish is continuing to [spread online](https://prototypr.io/toolbox/polish-ux-writing-tool/) organically.
...
- I'm now a (minor) contributor to the codebase.

### Sat, May 8 2021
- Analytics update: 40 new users joined in yesterday.
- We've figured out after a long (long!) research that Polish was briefly mentioned in a Webinar about UX writing.
- I've published the first [tweet of Polishapp](https://twitter.com/Polishapp1/status/1391051130394890240) to acquire more users.
...
- Found and requested to join a UX writing community on Slack.
...
- Encouragement is on the rise once we understand that VisBug mainly targets Front-End Engineers.
...
### Fri, April 23, 2021
- My Reddit post is now #6 in the Top posts of all time in that niche subreddit.


#### Thu, April 22, 2021
- Polish is now on GitHub: https://github.com/basil88/polishapp/
- We get initial analytics from the Chrome store (which comes in two days delay). 6 Installs! 
...
- We narrow our target audience further to _Freelance UX Writers_ based on our research. We believe that the current offering will is best suited for them.
...
- 2:00a - Good night! 😴
- In the morning, I show Polish to a few people at work and ask for feedback. Feedback is positive. Both of us are pumped, and we discuss distribution and target audience for the rest of the day. At around 11:15p, we zone in on UX Writers as a potential target audience. We start a google doc with ideas and tasks around midnight.
...
- 8:30p-8:47p - We continue to reflect on this idea on our own.
- 8:47p-8:52p - Chatting over Telegram to convince each other that this is a great idea.
